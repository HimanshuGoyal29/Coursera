    ...
    <body>
        ...
        <div class="container">
            ...
            <div style= "margin: 2% auto ;">
                ...
                <h1 style="text-align: center;"> Updating Autos for <?php  echo $_SESSION['name']; ?>  </h1>
                ...
                <form  method="POST">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="make"  value="<?php echo $make ?>" id="Make">
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="year" id="Year"  value="<?php echo $year ?>">    
                    </div>
                    
                    <div class="form-group">
                        <input class="form-control" type="text" name="mileage" id="mileage"  value="<?php echo $mileage ?>">    
                    </div>
